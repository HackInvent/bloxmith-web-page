...
"""
        ...
        try:
            ...
            # The isolated Studio uses the English pivot language for validation errors.
            visible(modal.locator("[data-page-status]")).to_contain_text("Invalid relative path")
            ...
            visible(source).to_have_value(html)
            modal.locator("[data-page-save]").click()
            visible(modal.locator("[data-page-status]")).to_contain_text("Page saved", timeout=10000)
